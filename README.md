...
## Краткое описание
Поисковой движок с открытым исходным кодом позволяет осуществлять поиск 
по контенту сайта, и легко встраивается в ваш сайт/web приложение. Для поиска
сайт парсится и формируется перевернутый индекс. Вся программа разбита на отдельные
модули, информация о которых находится ниже.
## Установка
